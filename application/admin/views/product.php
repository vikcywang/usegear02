<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active"><a href="<?php echo base_url('product')?>">产品管理</a></li>
		</ol>
	</div>
	<div class="row">
							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<td class="text-left"><a href="#" class="asc">产品名称</a></td>
										<td class="text-right"><a href="#">所属分类</a></td>
										<td class="text-right"><a href="#">产品属性</a></td>
								...
								foreach ( $product_all as $item ) {
									...
									?>
										...
										<td class="text-right"><a
											href="product/edit/<?php echo $item->product_id; ?>"
											class="btn btn-default">修改</a>
											<button type="button" data-toggle="tooltip" title=""
												class="btn btn-danger"
												onclick="confirm('确定吗？?') ? window.location.href='product/delete/<?php echo $item->product_id; ?>' : false;"
