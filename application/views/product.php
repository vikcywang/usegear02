...
<section id="hero" class="img-bg-bottom img-bg-soft"
	style="background-color:#9ca031;">
	<div class="container inner">
		<div class="row"
			style="background-color:#9ca031;">
			<div class="col-md-8 col-sm-9 center-block text-center">
				<header>
					<h1 style="color: white;">众诚软件产品中心</h1>
					<p style="color: white;">公司对各类行业管理软件的开发</p>
					<p style="color:white">解决和达到用户使用通用软件所不能满足要求的需要。</p>
				</header>
			</div>
			<!-- /.col -->
		</div>
						...
						<div class="panel-heading text-center">
							<h4 class="panel-title">
								<a class="panel-toggle collapsed" data-toggle="collapse"
									data-parent="#accordion" href="#content"> <span>更多产品</span>
								</a>
							</h4>
						</div>
						<!-- /.panel-heading -->
